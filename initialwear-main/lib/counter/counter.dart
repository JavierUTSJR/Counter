    ...
    return BlocListener<CounterCubit, int>(
      ...
      child: LayoutBuilder(
        builder: (context, constraints) {
          ...
          double titleFontSize = availableWidth * 0.06; // Tamaño del título
          double buttonIconSize = availableWidth * 0.1; // Tamaño de los iconos de botones
          double buttonTextSize = availableWidth * 0.04; // Tamaño del texto de botones
